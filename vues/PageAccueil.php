...
<body>
    <nav class="header">
            ...
            <div class="navigation">
                ...
                <div id="my-modal" class="modal">
                    <div class="modal-content-Publication">
                        <form action="index.php?uc=upload&action=upload" method="POST" enctype="multipart/form-data">
                            <div class="EnTeteModalPublication">
                                ...
                                <div class="arrow" onclick="fermer()"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="height: 24px; width: 24px;">
        ...
        <div class="menuDeroulantPdp" id="menuDeroulantPdp">
            ...
            <a href="#">
                <div class="profil"><span class="text"><i class="fa-solid fa-bookmark" style="margin-right: 10px;"></i> Enregistré</span></div>
            </a>
            <a href="#">
                <div class="profil"><span class="text"><i class="fa-solid fa-gear" style="margin-right: 10px;"></i></i> Paramètres</span></div>
            </a>
            <a href="#">
                <div class="profil"><span class="text"><i class="fa-solid fa-arrows-rotate" style="margin-right: 10px;"></i> Changer de compte</span></div>
            </a>
            <hr>
            <a href="index.php?uc=connexion&action=deconnexion">
                <div class="deconnexion" style="border-bottom-left-radius: 20px; border-bottom-right-radius: 20px;"><span class="text"> Déconnexion </span></div>
            </a>
        </div>
    </nav>
                ...
                <div class="publi">
                    ...
                    <div class="divDetailsPublication">
                        <div class="iconPublication">
                            <span><button style="background: transparent; border: none; cursor: pointer; display:flex; justify-content: center; padding: 8px 8px 8px 0px;"><svg aria-label="J’aime" class="_ab6-" color="rgb(38,38,38)" fill="rgb(38,38,38)" height="24" role="img" viewBox="0 0 24 24" width="24">
                            ...
                            <span><button style="background: transparent; border: none; cursor: pointer; display:flex; justify-content: center; padding: 8px;"><svg aria-label="Commenter" class="_ab6-" color="rgb(38,38,38)" fill="rgb(38,38,38)" height="24" role="img" viewBox="0 0 24 24" width="24">
                            ...
                            <span><button style="background: transparent; border: none; cursor: pointer; display:flex; justify-content: center; padding: 8px;"><svg aria-label="Partager la publication" class="_ab6-" color="rgb(38,38,38)" fill="rgb(38,38,38)" height="24" role="img" viewBox="0 0 24 24" width="24">
                                        <line fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" x1="22" x2="9.218" y1="3" y2="10.083"></line>
                                        <polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></polygon>
                                    </svg></button></span>
                            <span style="margin-left: auto; margin-right: -10px;"><button style="background: transparent; border: none; cursor: pointer; display:flex; justify-content: center; padding: 8px;"><svg aria-label="Enregistrer" class="_ab6-" color="rgb(38,38,38)" fill="rgb(38,38,38)" height="24" role="img" viewBox="0 0 24 24" width="24">
                    ...
                    <div class="mentionsLegales">
                        <div class="listeMentions">
                            <ul class="ulMentions">
                                ...
                                <li class="_ab8f" style="width: max-content"><a href="/about/jobs/"><span class="_aacl _aacn _aacu _aad1 _aad7 _aade">Emplois</span></a></li>
                                <li class="_ab8f"><a class="_ab8g" href="/legal/privacy/"><span class="_aacl _aacn _aacu _aad1 _aad7 _aade">Confidentialité</span></a></li>
                                <li class="_ab8f"><a class="_ab8g _ab8h" href="/legal/terms/"><span class="_aacl _aacn _aacu _aad1 _aad7 _aade">Conditions</span></a></li>
